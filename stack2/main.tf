...
module "bedrock_kb" {
  ...
  aurora_arn        = "arn:aws:rds:us-west-2:593249453830:cluster:my-aurora-serverless" 
  aurora_db_name    = "myapp"
  aurora_endpoint   = "my-aurora-serverless.cluster-czi58fctam23.us-west-2.rds.amazonaws.com" 
  ...
  aurora_secret_arn = "arn:aws:secretsmanager:us-west-2:593249453830:secret:my-aurora-serverless-SkOCCJ" 
